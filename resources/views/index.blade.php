      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
              At Mario Construction, we transform your living spaces with quality craftsmanship and exceptional
              attention to detail. Our team of skilled professionals specializes in a variety of services to meet all
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img src="images/mariopicture-removebg.png" alt="">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
              We have been offering residential, commercial and custom services since 2010 in Shelby Township.
      ...
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            ...
            <p>
              At Mario Construction, we provide professional home services that transform your living spaces into
              something extraordinary. Since our inception in 2010, we have been dedicated to delivering exceptional
              quality and craftsmanship to homeowners in Shelby Township and beyond.
              <br>
              <br>
              Our team of skilled experts specializes in a wide range of home improvement services, from intricate
              renovations to complete remodels. We are committed to exceeding your expectations with our meticulous
              attention to detail and personalized approach. Whether you’re looking to enhance your home’s
              functionality, update its appearance, or undertake a custom project, we have the expertise to make it
              happen.
            </p>
        ...
        <div class="owl-carousel">
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                  "Working with Mario Construction was a fantastic experience from start to finish. They remodeled our
                  kitchen and installed beautiful custom cabinets that exceeded our expectations. The team was
                  professional, attentive, and incredibly detail-oriented, ensuring everything was perfect. Our home
                  looks amazing, and we couldn’t be happier with the results. I highly recommend Mario Construction for
                  any home improvement needs!"
                </p>
              </div>
            </div>
          </div>
          <div class="item">
            <div class="box">
              ...
              <div class="client_text">
                <p>
                  "Mario Construction transformed our outdated basement into a beautiful and functional living space.
                  Their attention to detail and commitment to quality were evident in every aspect of the project. The
                  team was punctual, respectful, and kept us informed throughout the process. We are thrilled with the
                  final result and have received numerous compliments from friends and family. I highly recommend Mario
                  Construction for their exceptional craftsmanship and professionalism!"
                </p>
              </div>
            </div>
          </div>
  ...
  <section class="contact_section layout_padding">
    <div class="container">
      ...
      <div class="row">
        ...
        <div id="map"></div>
        <style>
          /* Style to make the map smaller and align it to the right */
          #map {
            width: 500px;
            /* Set a smaller width */
            height: 400px;
